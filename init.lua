...
require('lazy').setup({
  ...
  { 'Bilal2453/luvit-meta', lazy = true },
  {
    ...
    config = function()
      ...
      servers['clangd'].capabilities =
        require('blink.cmp').get_lsp_capabilities(vim.tbl_deep_extend('force', {}, capabilities, servers['clangd'].capabilities or {}))
